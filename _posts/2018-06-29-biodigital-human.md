...
description: Built the core WebGL rendering technology for the <b>BioDigital Human</b> anatomy visualization platform, which now serves over 3 million users. Contracted since 2009 to help maintain the platform.
