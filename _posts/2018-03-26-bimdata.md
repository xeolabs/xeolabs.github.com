...
<br><br>
When the glTF geometry is not quantized, then xeogl's GLTFModel automatically quantizes it while loading. At the same time, xeogl also 
...
VBO bind operations performed per frame. This currently enables us to render models up to around 200k+ objects.
<br><br> 
