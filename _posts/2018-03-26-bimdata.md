...
the use of plug-ins. While IFC viewers are typically written as desktop applications using OpenGL or DirectX, writing them
 ...
 <br><br>
 The challenge is how to engineer the viewer so as to be able to render large quantities of objects within the memory and 
 execution constraints of the browser.
