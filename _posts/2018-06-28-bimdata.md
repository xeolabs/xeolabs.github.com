...
<br><br>
 ![]({{ site.url }}/images/bimdata/bcf.gif)
  ...
  <!-- La Cali sponsored the aquatic centre project in Libourne, France. 50 people worked on the BIMData platform to view and collaborate on their several models. -->
